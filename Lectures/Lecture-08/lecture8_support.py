...
def precacc(N,labels=['Low accuracy','High accuracy','Low precision','High precision']):
    cm=['white','crimson']
    ...
    axes[0].set_ylabel(labels[0],fontsize=15)
    axes[2].set_ylabel(labels[1],fontsize=15)
    axes[2].set_xlabel(labels[2],fontsize=15)
    axes[3].set_xlabel(labels[3],fontsize=15);